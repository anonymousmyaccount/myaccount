function [trainf1, f1, sparsity] = quantileLPONENORMTSVR1(train, ytrain, test, s, c3, c1, tau1)
    n1 = length(train);
    e = ones(n1, 1);
    kerfPara.type = 'rbf';
    kerfPara.pars = s;
    ...
    % Solve the linear programming problem
        ...
        if exitflag <= 0
            error('linprog did not converge. Exit flag: %d. Check the problem setup.', exitflag);
        end
